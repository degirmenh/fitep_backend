    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_photo', models.ImageField(blank=True, null=True, upload_to='avatar/')),
                ('identity_number', models.CharField(max_length=25)),
                ('account_type', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'member'), (2, 'coach'), (3, 'admin')], null=True)),
